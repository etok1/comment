...
var CommentClass = /** @class */ (function () {
    function CommentClass(text, author, rating) {
        this.text = text;
        this.author = author;
        this.rating = rating;
    }
...
function renderUserComment(user, text, date, inputCont, commentCont, arrObj) {
...
document.addEventListener("DOMContentLoaded", function () {
                ...
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        data.forEach(function (item) {
                            ...
                            var comment = new CommentClass(item.text, user, item.rating);
                            console.log(user);
                            console.log(comment);
    ...
    var comment1 = new CommentClass("This is a great comment!", user, 0);
            ...
            commentBtn.addEventListener("click", function (event) {
                if (commentBtn.classList.contains("disabled")) {
                    ...
                    if (commentText !== "") {
                        ...
                        console.log(commentText);
                        renderUserComment(user, commentText, formattedDateUser, commentInput, commentCont, comments);
                    }
