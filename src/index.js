...
var CommentClass = /** @class */ (function () {
    function CommentClass(text, author, rating, isFav) {
        this.text = text;
        this.author = author;
        this.rating = rating;
        this.isFav = false;
...
function changeFave(color, comment) {
...
document.addEventListener("DOMContentLoaded", function () {
                ...
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        data.forEach(function (item) {
                            ...
                            var comment = new CommentClass(item.text, user, 0, false);
                            console.log(user);
                            console.log(comment);
            ...
            commentBtn.addEventListener("click", function (event) {
                if (commentBtn.classList.contains("disabled")) {
                    ...
                    if (commentText !== "") {
                        ...
                        var newComment = new CommentClass(commentText, user, 0, false);
                        console.log(commentText);
    ...
    console.log(comments);
    var getComment = localStorage.getItem("comments");
