...
function changeFave(color, comment, array) {
            ...
            commentBtn.addEventListener("click", function (event) {
                if (commentBtn.classList.contains("disabled")) {
                    ...
                    if (commentText !== "") {
                        ...
                        var newComment_1 = new CommentClass(commentText, user, 0, formattedDateUser, false, 0);
                        renderUserComment(newComment_1, formattedDateUser, commentInput, commentCont, commentBtn);
                        comments.push(newComment_1);
                        var minusBtn = document.querySelector(".comment__btn-minus");
                        var plusBtn = document.querySelector(".comment__btn-plus");
                        var countSpan_1 = document.querySelector(".comment__count");
                        if (minusBtn && plusBtn && countSpan_1) {
                            minusBtn.addEventListener("click", function () {
                                newComment_1.decreaseRating();
                                updateRatingDisplay(newComment_1, countSpan_1);
                            });
                            plusBtn.addEventListener("click", function () {
                                newComment_1.increaseRating();
                                updateRatingDisplay(newComment_1, countSpan_1);
                            });
                        }
                        else {
                        ...
                        changeFave("#a1a1a1", newComment_1, comments);
                        console.log(comments);
